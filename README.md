...
```
$ docker image tag demo manvinirwal/demo
$ docker push manvinirwal/demo
```
...
```
$ kubectl scale deployment <app-name> --replicas <replica-count> -n manvi
```
...
```
$ kubectl set image deployment/<app-name>-app <app-name>=<new-image>  -n manvi
```
...
```
$ kubectl expose service jhipster-registry --type=NodePort --name=exposed-registry -n manvi
```

and explore the details using

```
$ kubectl get svc exposed-registry -n manvi
```

For scaling the JHipster registry, use

```
$ kubectl scale statefulset jhipster-registry --replicas 3 -n manvi
```
